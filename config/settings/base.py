"""
Base settings for MyHub Events project.
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'myhub_events.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Dragos Nicu""", 'contact@dragosnicu.com'),
]
...
ACCOUNT_ADAPTER = 'myhub_events.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'myhub_events.users.adapters.SocialAccountAdapter'
