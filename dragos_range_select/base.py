...
from . import UID
from .forms import DragosRangeSelectInputForm
...
class DragosRangeSelectInputPlugin(FormFieldPlugin):
    """Range select input plugin."""

    uid = UID
    name = _("Dragos Range select")
    group = _("Fields")
    form = DragosRangeSelectInputForm
